...
import planetaryprotector.menu.MenuCredits;
...
public class MenuPrologue extends Menu{
    public MenuPrologue(GUI gui){
        super(gui, null);
    }
    ...
    public void renderBackground(){
        ...
        drawRect(0, 0, Display.getWidth(), Display.getHeight(), ImageStash.instance.getTexture("/gui/stoneBackground.png"));
        drawRect(0, Display.getHeight()*2, Display.getWidth(), Display.getHeight(), ImageStash.instance.getTexture("/gui/stoneBackground.png"));
    ...
    private static class MenuComponentPrologueMineShaft extends MenuComponent{
        ...
        public void render(){
            ...
            for(int i = 0; i<5; i++){
                ...
                drawRect(x+X, y+Y, x+X+W, y+Y+H, ImageStash.instance.getTexture("/textures/him.png"));
            }
        }
    }
