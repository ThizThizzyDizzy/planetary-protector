...
public abstract class HorizontalNoun extends Renderer2D{
    ...
    public final void draw(double x, double y, double size){
        ...
        AdvancedRenderer2D.drawOval(x, y, w/2, h/2, size/12, 100, 0);//outer oval
        ...
        render(x, y, w, h);
        if(plural){
            AdvancedRenderer2D.drawOval(x, y, w/2, h/2, -h/5, 360, 0, 44, 46);
            AdvancedRenderer2D.drawOval(x, y, w/2, h/2, -h/5, 360, 0, 134, 136);
            AdvancedRenderer2D.drawOval(x, y, w/2, h/2, -h/5, 360, 0, 224, 226);
            AdvancedRenderer2D.drawOval(x, y, w/2, h/2, -h/5, 360, 0, -46, -44);
        }
        double Y = 0;
