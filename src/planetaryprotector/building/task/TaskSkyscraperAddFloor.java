...
public class TaskSkyscraperAddFloor extends Task{
    private final MenuComponentSkyscraper skyscraper;
    public TaskSkyscraperAddFloor(MenuComponentSkyscraper skyscraper){
        this(skyscraper, 1);
    }
    public final int floors;
    public TaskSkyscraperAddFloor(MenuComponentSkyscraper skyscraper, int floors){
    ...
    public boolean canPerform(){
        if(skyscraper.floorCount+floors>MenuComponentSkyscraper.maxHeight)return false;
